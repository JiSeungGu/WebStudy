...
<%
    ...
    List<MovieVO> list=new ArrayList<MovieVO>();
       if(index==0)
       {
       list=MovieDAO.movieListData(map);
       }
       else
       {
    ...
    /*
      new Cookie(키,값)
         m1 m2 ....
         => 키를 읽어올 때 => cookie.getName()
         => 값을 읽어올 때 => cookie.getValue()
    */
...
<body>
   ...
   %>
   <div class="row">
   <h3>최근 방문한 영화 &nbsp; <a href="../movie/delete.jsp" class="btn btn-sm btn-success">쿠키 삭제</a> </h3>
      <%
         if(cList==null || cList.size()<1) //방문기록이 없음
         {
   %>
